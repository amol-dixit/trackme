...
export default class AddressInput extends LightningElement {
  ...
  set address(value) {
   ...
   /* if(this.addressobj != null){
      if (this.addressobj.BillingCountry === "USA") {
        this.addressobj.BillingCountry = "United States";
      }
    }*/
 ...
 // @track addressobj;
  ...
  cloneAdd(){
    let tempObj = {};
    tempObj.BillingStreet = this.addressobj.BillingStreet;
    tempObj.BillingCity = this.addressobj.BillingCity;
    tempObj.BillingState = this.addressobj.BillingState;
    tempObj.BillingPostalCode = this.addressobj.BillingPostalCode;
    tempObj.BillingCountry = this.addressobj.BillingCountry;
    if(this.addressobj.BillingCountry == undefined){
      tempObj.BillingCountry = 'USA';
    }
    return tempObj;
  ...
  handleStreet2Change(event) {
    ...
    this.addressobj = this.cloneAdd();
    this.addressobj.BillingStreet2 = event.detail.value;
    this.validateAddress();
  }
  handleCityChange(event) {
    this.touched.add("city");
    this.addressobj = this.cloneAdd();
    this.addressobj.BillingCity = event.detail.value;
    this.validateAddress();
  }
  handlePostCodeChange(event) {
    this.touched.add("zip");
    this.addressobj = this.cloneAdd();
    this.addressobj.BillingPostalCode = event.detail.value;
    this.validateAddress();
  }
  handleStateChange(event) {
    this.touched.add("state");
    this.addressobj = this.cloneAdd();
    this.addressobj.BillingState = event.detail.value;
    this.validateAddress();
  }
  handleCountryChange(event) {
    this.touched.add("country");
    this.addressobj = this.cloneAdd();
    this.addressobj.BillingCountry = event.detail.value;
    this.validateAddress();
  }

  handleInternationalChange(event) {
    this.addressobj = this.cloneAdd();
    this.addressobj.internationalAddress = event.target.checked;
    if (this.addressobj.internationalAddress) {
